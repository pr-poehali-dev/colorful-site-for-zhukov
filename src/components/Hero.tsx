...
const Hero = () => {
  return (
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-violet-600 via-purple-600 to-blue-600 text-white overflow-hidden">
      ...
      <div className="absolute inset-0 bg-gradient-to-br from-violet-900/20 to-purple-900/20 opacity-50"></div>
        ...
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-lg text-purple-200 max-w-2xl mx-auto mb-8">
              Создаю современные, функциональные и красивые веб-сайты, которые
              работают на всех устройствах и приносят результат вашему бизнесу
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-white text-white hover:bg-white hover:text-purple-600 font-semibold px-8 py-3 text-lg transition-all duration-300 gap-2"
            >
      ...
      <div
        className="absolute bottom-20 right-10 w-16 h-16 bg-gradient-to-r from-blue-500 to-purple-500 rounded-full opacity-20 animate-pulse"
        style={{ animationDelay: "1s" }}
      ></div>
      <div
        className="absolute top-1/2 left-20 w-12 h-12 bg-gradient-to-r from-violet-500 to-pink-500 rounded-full opacity-20 animate-pulse"
